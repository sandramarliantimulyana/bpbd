...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            ...
            <!-- <a href = "javascript:void(0);" > Admin <b > BSB </b > </a > -- > <!-- <small > SIM - Logistik BPBD Majalengka </small> -->
        </div>
        <div class="card">
            <div class="body">
                <form id="sign_in" method="POST" action="<?= base_url('auth') ?>">
                    ...
                    <div class="image" style="margin-bottom: 5%;">
                        <img class="m-l-125" src="<?= base_url('gambar') ?>/logo.png" width="65" height="65" alt="Login" />
                    </div>
